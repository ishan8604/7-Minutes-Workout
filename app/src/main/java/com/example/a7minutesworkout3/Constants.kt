...
object Constants {
    fun defaultExerciseList(): ArrayList<ExerciseModel> {
        ...
        val stepOnChair = ExerciseModel(5, "Step On Chair", R.drawable.ic_step_up_onto_chair, false, false)
        exerciseList.add(stepOnChair)
        val squat = ExerciseModel(6, "Squat", R.drawable.ic_squat, false, false)
        exerciseList.add(squat)
        val tricepsDipOnChair = ExerciseModel(7, "Tricep Dip On Chair", R.drawable.ic_triceps_dip_on_chair, false, false)
